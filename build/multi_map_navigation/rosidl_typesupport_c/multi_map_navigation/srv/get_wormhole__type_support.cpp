...
static const _GetWormhole_Request_type_support_symbol_names_t _GetWormhole_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_map_navigation, srv, GetWormhole_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_map_navigation, srv, GetWormhole_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, multi_map_navigation, srv, GetWormhole_Request)() {
  return &::multi_map_navigation::srv::rosidl_typesupport_c::GetWormhole_Request_message_type_support_handle;
}
...
static const _GetWormhole_Response_type_support_symbol_names_t _GetWormhole_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_map_navigation, srv, GetWormhole_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_map_navigation, srv, GetWormhole_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, multi_map_navigation, srv, GetWormhole_Response)() {
  return &::multi_map_navigation::srv::rosidl_typesupport_c::GetWormhole_Response_message_type_support_handle;
}
...
static const _GetWormhole_type_support_symbol_names_t _GetWormhole_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_map_navigation, srv, GetWormhole)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_map_navigation, srv, GetWormhole)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, multi_map_navigation, srv, GetWormhole)() {
  return &::multi_map_navigation::srv::rosidl_typesupport_c::GetWormhole_service_type_support_handle;
}
