    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'multi_map_navigation.action.Navigate_Goal')
            logger.debug(
...
class Metaclass_Navigate_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'multi_map_navigation.action.Navigate_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigate_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'multi_map_navigation.action.Navigate_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigate_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from multi_map_navigation.action import Navigate
...
class Navigate_SendGoal_Request(metaclass=Metaclass_Navigate_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'multi_map_navigation/Navigate_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['multi_map_navigation', 'action'], 'Navigate_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from multi_map_navigation.action._navigate import Navigate_Goal
...
class Metaclass_Navigate_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'multi_map_navigation.action.Navigate_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from multi_map_navigation.action import _navigate
...
class Navigate_SendGoal(metaclass=Metaclass_Navigate_SendGoal):
    from multi_map_navigation.action._navigate import Navigate_SendGoal_Request as Request
    from multi_map_navigation.action._navigate import Navigate_SendGoal_Response as Response
...
class Navigate_GetResult_Response(metaclass=Metaclass_Navigate_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'multi_map_navigation/Navigate_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['multi_map_navigation', 'action'], 'Navigate_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from multi_map_navigation.action._navigate import Navigate_Result
...
class Metaclass_Navigate_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'multi_map_navigation.action.Navigate_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_GetResult(metaclass=Metaclass_Navigate_GetResult):
    from multi_map_navigation.action._navigate import Navigate_GetResult_Request as Request
    from multi_map_navigation.action._navigate import Navigate_GetResult_Response as Response
...
class Metaclass_Navigate_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'multi_map_navigation.action.Navigate_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_FeedbackMessage(metaclass=Metaclass_Navigate_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'multi_map_navigation/Navigate_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['multi_map_navigation', 'action'], 'Navigate_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from multi_map_navigation.action._navigate import Navigate_Feedback
...
class Metaclass_Navigate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'multi_map_navigation.action.Navigate')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate(metaclass=Metaclass_Navigate):
    ...
    from multi_map_navigation.action._navigate import Navigate_Goal as Goal
    # The result message defined in the action definition.
    from multi_map_navigation.action._navigate import Navigate_Result as Result
    # The feedback message defined in the action definition.
    from multi_map_navigation.action._navigate import Navigate_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from multi_map_navigation.action._navigate import Navigate_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from multi_map_navigation.action._navigate import Navigate_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from multi_map_navigation.action._navigate import Navigate_FeedbackMessage as FeedbackMessage
