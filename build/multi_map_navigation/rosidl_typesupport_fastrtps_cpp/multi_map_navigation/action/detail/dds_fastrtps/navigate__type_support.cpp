...
#include "multi_map_navigation/action/detail/navigate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const multi_map_navigation::action::Navigate_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_map_navigation::action::Navigate_Goal & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_map_navigation::action::Navigate_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::action::Navigate_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<multi_map_navigation::action::Navigate_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_multi_map_navigation
const rosidl_message_type_support_t *
get_message_type_support_handle<multi_map_navigation::action::Navigate_Goal>()
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_Goal)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_multi_map_navigation
cdr_serialize(
  const multi_map_navigation::action::Navigate_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_map_navigation::action::Navigate_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = multi_map_navigation::action::Navigate_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::action::Navigate_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<multi_map_navigation::action::Navigate_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_Result)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_multi_map_navigation
cdr_serialize(
  const multi_map_navigation::action::Navigate_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: current_x
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_map_navigation::action::Navigate_Feedback & ros_message)
{
  // Member: current_x
  cdr >> ros_message.current_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = multi_map_navigation::action::Navigate_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::action::Navigate_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<multi_map_navigation::action::Navigate_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_Feedback)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_Feedback__handle;
}
...
// functions for multi_map_navigation::action::Navigate_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_multi_map_navigation
cdr_serialize(
  const multi_map_navigation::action::Navigate_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  multi_map_navigation::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_map_navigation::action::Navigate_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  multi_map_navigation::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    multi_map_navigation::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        multi_map_navigation::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = multi_map_navigation::action::Navigate_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::action::Navigate_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<multi_map_navigation::action::Navigate_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_SendGoal_Request)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_multi_map_navigation
cdr_serialize(
  const multi_map_navigation::action::Navigate_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_map_navigation::action::Navigate_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = multi_map_navigation::action::Navigate_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::action::Navigate_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<multi_map_navigation::action::Navigate_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_SendGoal_Response)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Response__handle;
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_SendGoal)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_multi_map_navigation
cdr_serialize(
  const multi_map_navigation::action::Navigate_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_map_navigation::action::Navigate_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = multi_map_navigation::action::Navigate_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::action::Navigate_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<multi_map_navigation::action::Navigate_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_GetResult_Request)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for multi_map_navigation::action::Navigate_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_multi_map_navigation
cdr_serialize(
  const multi_map_navigation::action::Navigate_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_map_navigation::action::Navigate_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        multi_map_navigation::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = multi_map_navigation::action::Navigate_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::action::Navigate_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<multi_map_navigation::action::Navigate_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_GetResult_Response)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Response__handle;
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_GetResult)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_GetResult__handle;
}
...
// functions for multi_map_navigation::action::Navigate_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_multi_map_navigation
cdr_serialize(
  const multi_map_navigation::action::Navigate_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_map_navigation::action::Navigate_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        multi_map_navigation::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = multi_map_navigation::action::Navigate_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::action::Navigate_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<multi_map_navigation::action::Navigate_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, action, Navigate_FeedbackMessage)() {
  return &multi_map_navigation::action::typesupport_fastrtps_cpp::_Navigate_FeedbackMessage__handle;
}
