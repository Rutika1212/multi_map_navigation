...
#include "multi_map_navigation/srv/detail/get_wormhole__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  // Member: map_from
  cdr << ros_message.map_from;
  // Member: map_to
  cdr << ros_message.map_to;
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_map_navigation::srv::GetWormhole_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::srv::GetWormhole_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<multi_map_navigation::srv::GetWormhole_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetWormhole_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const multi_map_navigation::srv::GetWormhole_Request *>(
...
static size_t _GetWormhole_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetWormhole_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetWormhole_Request__callbacks = {
...
static rosidl_message_type_support_t _GetWormhole_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetWormhole_Request__callbacks,
...
{
  return &multi_map_navigation::srv::typesupport_fastrtps_cpp::_GetWormhole_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = multi_map_navigation::srv::GetWormhole_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_map_navigation::srv::GetWormhole_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<multi_map_navigation::srv::GetWormhole_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetWormhole_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const multi_map_navigation::srv::GetWormhole_Response *>(
...
static size_t _GetWormhole_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetWormhole_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetWormhole_Response__callbacks = {
  "multi_map_navigation::srv",
...
static rosidl_message_type_support_t _GetWormhole_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetWormhole_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &multi_map_navigation::srv::typesupport_fastrtps_cpp::_GetWormhole_Response__handle;
}
...
static service_type_support_callbacks_t _GetWormhole__callbacks = {
  "multi_map_navigation::srv",
  "GetWormhole",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, srv, GetWormhole_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_map_navigation, srv, GetWormhole_Response)(),
...
static rosidl_service_type_support_t _GetWormhole__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetWormhole__callbacks,
...
{
  return &multi_map_navigation::srv::typesupport_fastrtps_cpp::_GetWormhole__handle;
}
